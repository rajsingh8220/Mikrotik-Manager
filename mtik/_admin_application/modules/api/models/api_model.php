...
class Api_model extends CI_Model {
    ...
    public  $attempts = 4;       // Connection attempt count
    public  $connected = false;  // Connection state
    public  $delay = 1;          // Delay between connection attempts in seconds
    public  $port = 8728;        // Port to connect to
    public  $timeout = 2;        // Connection attempt timeout and data read timeout
    public  $socket;   
    public $receiveddone = false; 
	public $data = array();
	function __construct(){
		parent::__construct();
                
		$this->load->model('home/home_model');
		$this->data['submenu'] = 'home/submenu_home';
